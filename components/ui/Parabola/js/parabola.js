define('parabola',['jquery'],function(require,exports,module){
    ...
    Parabola.prototype = {
        ...
        init: function (options) {
            ...
            //this.driftY Y轴的偏移总量
            if (ops.targetEl) {
                this.driftX = toInteger($(ops.targetEl).css("left")) - this.elOriginalLeft;
                this.driftY = toInteger($(ops.targetEl).css("top")) - this.elOriginalTop;
            } else {
